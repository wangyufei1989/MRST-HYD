...
DBP=R.*Tk(r3)./P(r3).^2;
DCP=-1.*(-bm.*R.*Tk(r3)./P(r3).^2+am(r3)./sqrt(Tk(r3))./P(r3).^2);
DDP=am(r3).*bm./sqrt(Tk(r3))./P(r3).^2;
...
DBP=R.*Tk(r2)./P(r2).^2;
DCP=-1.*(-bm.*R.*Tk(r2)./P(r2).^2+am(r2)./sqrt(Tk(r2))./P(r2).^2);
DDP=am(r2).*bm./sqrt(Tk(r2))./P(r2).^2;
...
DBP=R.*Tk(r1)./P(r1).^2;
DCP=-1.*(-bm.*R.*Tk(r1)./P(r1).^2+am(r1)./sqrt(Tk(r1))./P(r1).^2);
DDP=am(r1).*bm./sqrt(Tk(r1))./P(r1).^2;
